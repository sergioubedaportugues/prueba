...
public class PruebaCrearCentro {
	...
	@Given("un {string}, {string}, {string} y {string}")
	public void un_y(String nombreCentro, String direccionCentro, String numeroVacunas, String numeroSanitarios) {
		/*CentroSalud centro = new CentroSalud();
		nombreCentro= "Zendal"; direccionCentro="Avenida Parque"; numeroVacunas="7780"; numeroSanitarios="123";  
		centro.setnombreCentro(nombreCentro);
		centro.setdireccionCentro(direccionCentro);
		centro.setnumeroVacunas(numeroVacunas);
		centro.setnumetoSanitarios(numeroSanitarios);
