...
<<<<<<< HEAD
			...
			while (!insertada) {
				...
				if (cita.getByDiaAndNombreCentroAndHorasStartingWith(citaNueva.getDia(), citaNueva.getCs().getNombre(),
						...
						&& cita.getByDiaAndNombreCentroAndHorasStartingWith(segundaCita.getDia(), segundaCita.getCs().getNombre(),
