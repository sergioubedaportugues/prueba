  ...
  function(ko, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ThemeUtils, moduleUtils, ModuleAnimations, ArrayDataProvider, KnockoutTemplateUtils) {
     function ControllerViewModel() {
      ...
      var navDataRouter = [
        ...
        { path: 'categoria', detail: { label: 'Categoría', iconClass: 'oj-ux-ico-fire' } },
        { path: 'estado', detail: { label: 'Estado', iconClass: 'oj-ux-ico-information-s' } }
      ];

      // Router setup
      var router = new CoreRouter(navDataRouter, {
      ...
      // route.
      this.navDataProvider = new ArrayDataProvider(navDataRouter.slice(1), {keyAttributes: "path"});
